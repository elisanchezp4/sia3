...
@XmlRootElement(name = "crearUsuarioExternoRs")
public class CrearUsuarioExternoRs {
    ...
    protected JAXBElement<IdentificadorUsuario> informacionUsuario;
     ...
     * @return
     *     possible object is
     *     {@link JAXBElement }{@code <}{@link IdentificadorUsuario }{@code >}
     *     
     */
    public JAXBElement<IdentificadorUsuario> getInformacionUsuario() {
     ...
     *     
     */
    public void setInformacionUsuario(JAXBElement<IdentificadorUsuario> value) {
