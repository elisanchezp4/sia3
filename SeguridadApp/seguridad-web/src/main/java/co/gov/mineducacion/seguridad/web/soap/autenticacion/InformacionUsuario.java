...
public class InformacionUsuario {
    ...
    @XmlElementRef(name = "clave", namespace = "http://soap.mineducacion.gov.co/12/seguridad/sia3", type = JAXBElement.class, required = false)
    protected JAXBElement<String> clave;
    @XmlElementRef(name = "userId", namespace = "http://soap.mineducacion.gov.co/12/seguridad/sia3", type = JAXBElement.class, required = false)
