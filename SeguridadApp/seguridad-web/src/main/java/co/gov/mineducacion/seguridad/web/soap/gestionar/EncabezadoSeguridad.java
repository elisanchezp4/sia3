...
public class EncabezadoSeguridad {
    ...
    @XmlElementRef(name = "ipHost", namespace = "http://soap.mineducacion.gov.co/11/seguridad/sia3", type = JAXBElement.class, required = false)
    protected JAXBElement<String> ipHost;
     ...
     *     
     */
    public JAXBElement<String> getIpHost() {
        return ipHost;
    }
     ...
     *     
     */
    public void setIpHost(JAXBElement<String> value) {
        this.ipHost = value;
    }
