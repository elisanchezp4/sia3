...
/**
 * Servicios REST para operaciones CRUD y de negocio sobre la entidad BitacoraAuditoria
 * @author jsoto
 */
@Stateless
@Path("servicios/bitacoraauditoria")
public class ServicioBitacoraAuditoria {
    ...
    /**
     * Realiza un consulta en la entidad BitacoraAuditoria aplicando los filtros, el ordenamiento,
     ...
     * Ej. Una secuencia de parámetros de filtrado puede ser {@literal bitacoraAuditoriaId>1&bitacoraAuditoriaName:LIKE:juan}
     ...
     * Ej. Una secuencia de parámetros de ordenamiento puede ser: bitacoraAuditoriaId$ASC, bitacoraAuditoriaName$DESC
     ...
     * @return Una lista de DAOs de los BitacoraAuditoria que se consultaron con los parámetros enviados por el cliente
    ...
    public List<BitacoraAuditoriaDTO> consultar(@QueryParam("filterBy") String filterBy, 
        ...
        return negocioBitacoraAuditoria.consultar(filterBy, orderBy, from, to);
     ...
     * 
     * @param bitacoraAuditoriaDTO El DAO de la entidad BitacoraAuditoria a crear. Este se envía en el cuerpo de la
     * solicitud POST como un objeto JSON.
     * @return El identificador de la insntancia de BitacoraAuditoria recién creado
     */
    @POST
    ...
    public BitacoraAuditoriaDTO crear(BitacoraAuditoriaDTO bitacoraAuditoriaDTO) {
        ...
        return negocioBitacoraAuditoria.crear(bitacoraAuditoriaDTO);
        // protected region Use esta region para su implementacion end 
        
    }

    /**
     * Actualiza en la base de datos el bitacoraAuditoria que se pasa como parámetro.
     * 
     * @param bitacoraAuditoriaDTO El DAO de la entidad BitacoraAuditoria a actualizar. Este se envía en el cuerpo de la
     * solicitud PUT como un objeto JSON.
     * @return El identificador de la instancia de la entidad BitacoraAuditoria que ha sido actualizado
     */
    @PUT
    @Consumes({APPLICATION_JSON})
    @Produces({APPLICATION_JSON})
    public BitacoraAuditoriaDTO actualizar(BitacoraAuditoriaDTO bitacoraAuditoriaDTO){
        ...
        return negocioBitacoraAuditoria.actualizar(bitacoraAuditoriaDTO);
        // protected region Use esta region para su implementacion end
    }

    /**
     * Elimina el bitacoraAuditoria con el identificador que se pasa como parámetro.
     * 
     * @param bitacoraId Valor del atributo del identificador de la instancia de la entidad  bitacoraAuditoria a eliminar
    ...
    public String eliminar(@QueryParam("bitacoraId") BigDecimal bitacoraId) {
        ...
        return negocioBitacoraAuditoria.eliminar(bitacoraId);
        // protected region Use esta region para su implementacion end
    }
    ...
    public String contar(@QueryParam("filterBy") String filterBy,
        ...
        return negocioBitacoraAuditoria.contar(filterBy, from, to);
        // protected region Use esta region para su implementacion end
    }    
     ...
     * parámetro debe ir separado por coma : ','.
     * Ej. Una secuencia de parámetros de ordenamiento puede ser: bitacoraAuditoriaId$ASC, bitacoraAuditoriaName$DESC
     * @param atributo Nombre del atributo de la entidad BitacoraAuditoria del cual se quieren obtener los diferentes valores.
    ...
    public List<String> consultarLista(@QueryParam("filterBy") String filterBy,
        ...
        // protected region Use esta region para su implementacion on begin
        return negocioBitacoraAuditoria.consultarLista(filterBy, orderBy, atributo);
        // protected region Use esta region para su implementacion end
    }     
