 ...
 */
public abstract class AbstractEntityManagerEJB<T> {

	protected static final String PERSISTENCE_UNIT="ParametrosPU";
	
    private Class<T> entityClass;

    protected AbstractEntityManagerEJB(Class<T> entityClass) {
