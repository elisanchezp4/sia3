...
import static co.gov.mineducacion.seguridad.modelo.manejadores.utils.ManejadorCrud.IGNORAR_PARAMETRO_CONSULTA;
import co.gov.mineducacion.seguridad.modelo.utils.UtilConstantes;
 ...
 *
 * @param <E>
 *            La entidad sobre la cual se realizan las operaciones CRUD o
 *            operaciones de negocio
 * @param <D>
 *            El DAO asociado a la entidad E que se utiliza para transmitir su
...
public abstract class NegocioAbstracto<E, D> {
	 ...
	 * @return Una lista con los filtros parseados a su correspondiente clase
	 *         java
	...
	/**
	 * Invoca el método decodificarOrdenamiento validando antes que el orderBy
	 * no sea nulo ni este vacío.
	 * 
	 * @param orderBy
	...
	/**
	 * Construye la información de agrupamiento para la consulta que se extrae
	 * de la url.
	 * 
	 * @param atributo
	 *            El atributo de la entidad para el cual se quiere consultar la
	 *            lista de valores.
	 * @return La información de agrupamiento a ejecutar en la consulta SELECT
	 * @throws InvalidParameterException
	 *             Si el atributo especificado no existe en la entidad T
	 */
	...
	/**
	 * Convierte una lista de la entidad E a una lista de DAOs D
	 * correspondientes a la entidad E.
	 * 
	 * @param entidades
	 *            Lista de entidades a ser transformada
	...
	/**
	 * Convierte la entidad E que se pasa como parámetro a su correspondiente
	 * DAO D.
	 * 
	 * @param entidad
	 *            Entidad a ser trasnformada
	 * @return Un DAO D con la información de la entidad que se pasó como
	 *         parámetro
	 */
	...
	private List<InformacionFiltro> decodificarFiltro(String filterBy) throws InvalidParameterException {
		...
		for (String condicion : decodificarParametrosFiltro(filterBy)) {
			...
			filtros.add(new InformacionFiltro(tipoFiltro, campo, valor, tipoOperador));
		}
	...
	/**
	 * Identifica el tipo de operador (AND o OR) que concatena la condicion que
	 * se pasa como parámetro con la siguiente condición. Si es la última
	 * condición devuelve AND.
	 * 
	 * @param filterBy
	 *            Cadena de caracteres con los parámetros de filtrado. Cada
	 *            parámetro está compuesto por el nombre del campo por el que se
	 ...
	 *            {@literal customerId>1&customerName:LIKE:juan}
	 * @param condicion
	 *            La condición (o parámetro) para la cual se quiere identificar
	 *            el concatenador
	...
	private TipoOperador identificarTipoOperador(String filterBy, String condicion) {
		...
		if (index + condicion.length() == filterBy.length()) {
			// Corresponde a la última condición por lo que no importa el
			// operador que se coloque
	...
	/**
	 * Devuelve los ordenamientos que venían definidos en la cadena que se pasa
	 * como parámetro.
	 * 
	 * @param orderBy
	 *            Cadena de caracteres con los parámetros de ordenamiento. Cada
	...
	/**
	 * Devuelve los parametros que se pasan dentro del String cada parametro
	 * esta separado por el carácter & o por el caracter | La estructura del
	 * parametro es: 1. Nombre campo por el que se va filtrar 2. Operador de
	 * comparación (Exacto, Like, etc -> TipoFiltro) 3. Valor del campo 4.
	 * Operador de concatenación
	 * 
	 * Ej. nombre=david&apellido!=sepulveda devuelve una lista con los
	 * siguientes elementos: 1. nombre=david 2. apellido!=sepulveda
	 * 
	 * @param filterBy
	 *            Cadena de caracteres con los parámetros de filtrado. Cada
	 *            parámetro está compuesto por el nombre del campo por el que se
	 ...
	 * esta separado por el carácter & o por el caracter | La estructura del
	 * parametro es: 1. Nombre campo por el que se va filtrar 2. Operador de
	 * comparación de división ':' 3. Direccionalidad del ordenamiento
	 * (TipoOrdenamiento)
	 * 
	 ...
	 * 
	 * @param parametro
	 *            Cualquiera de los parametros que viene definido en la
	 *            condición filterBy de la consulta. La estructura del parametro
	 *            es: 1. Nombre campo por el que se va filtrar 2. Operador de
	 *            comparación de división ':' 3. Direccionalidad del
	 ...
	 * iguales a 0, y que el parámetro to sea mayor o igual al parámetro from.
	 * Si los parámetros son válidos devuelve un objeto RangoConsulta con la
	 * información contenida en ellos, de lo contrario lanza una excepción.
	 * 
	 * @param from
	 *            Entero que especifica el numero de registro inicial que
	 *            devuelve al consulta
	 * @param to
	 *            Entero que especifica el numero de registro final que devuelve
	 *            al consulta
	 ...
	 *            Nombre del atributo de la entidad E
	 * @return boolean
	 */
	 ...
	 * 
	 * @param className
	 *            Nombre de la clase que contiene al servicio
