...
public class ApplicationConfig extends Application {
	...
	private void addRestResourceClasses(Set<Class<?>> resources) {
        resources.add(co.gov.mineducacion.seguridad.modelo.Oauth.AuthEndpoint.class);
        resources.add(co.gov.mineducacion.seguridad.modelo.Oauth.RedirectUriEndpoint.class);
        resources.add(co.gov.mineducacion.seguridad.modelo.Oauth.RegistrationEndpoint.class);
        resources.add(co.gov.mineducacion.seguridad.modelo.Oauth.ResourceBodyEndpoint.class);
        resources.add(co.gov.mineducacion.seguridad.modelo.Oauth.ResourceHeaderEndpoint.class);
        resources.add(co.gov.mineducacion.seguridad.modelo.Oauth.ResourceQueryEndpoint.class);
        resources.add(co.gov.mineducacion.seguridad.modelo.Oauth.TokenEndpoint.class);
        resources.add(co.gov.mineducacion.seguridad.web.servicio.ServicioAplicaciones.class);
        resources.add(co.gov.mineducacion.seguridad.web.servicio.ServicioBitacoraAuditoria.class);
        resources.add(co.gov.mineducacion.seguridad.web.servicio.ServicioOperaciones.class);
        resources.add(co.gov.mineducacion.seguridad.web.servicio.ServicioRoles.class);
        resources.add(co.gov.mineducacion.seguridad.web.servicio.ServicioTokensActivos.class);
        resources.add(co.gov.mineducacion.seguridad.web.servicio.ServicioUsuarios.class);
        resources.add(co.gov.mineducacion.seguridad.web.servicio.ServicioUsuariosRol.class);
        resources.add(co.gov.mineducacion.seguridad.web.servicio.utils.CORSFilter.class);
        resources.add(co.gov.mineducacion.seguridad.web.servicio.utils.ListaStringMessageBodyWriter.class);
        resources.add(co.gov.mineducacion.seguridad.web.servicio.utils.ServiceExceptionMapper.class);
