...
/**
 * Servicios REST para operaciones CRUD y de negocio sobre la entidad Roles
 * @author jsoto
 */
@Stateless
@Path("servicios/roles")
public class ServicioRoles {
    ...
    /**
     * Realiza un consulta en la entidad Roles aplicando los filtros, el ordenamiento,
     ...
     * Ej. Una secuencia de parámetros de filtrado puede ser {@literal rolesId>1&rolesName:LIKE:juan}
     ...
     * Ej. Una secuencia de parámetros de ordenamiento puede ser: rolesId$ASC, rolesName$DESC
     ...
     * @return Una lista de DAOs de los Roles que se consultaron con los parámetros enviados por el cliente
    ...
    public List<RolesDTO> consultar(@QueryParam("filterBy") String filterBy, 
        ...
        return negocioRoles.consultar(filterBy, orderBy, from, to);
        // protected region Use esta region para su implementacion end 
    }

    /**
     * Crea el roles que se pasa como parámetro en la base de datos.
     *  HBT agregar excepcion SIA3Exception
     * 
     * @param rolesDTO El DAO de la entidad Roles a crear. Este se envía en el cuerpo de la
     * solicitud POST como un objeto JSON.
     * @return El identificador de la insntancia de Roles recién creado
     */
    @POST
    ...
    /**
     * Actualiza en la base de datos el roles que se pasa como parámetro.
     * HBT agrega excepcion SIA3Exception
     * 
     * @param rolesDTO El DAO de la entidad Roles a actualizar. Este se envía en el cuerpo de la
     * solicitud PUT como un objeto JSON.
     * @return El identificador de la instancia de la entidad Roles que ha sido actualizado
     */
    @PUT
    @Consumes({APPLICATION_JSON})
    @Produces({APPLICATION_JSON})
    public void actualizar(RolesDTO rolesDTO) throws SIA3Exception{
        ...
        negocioRoles.actualizar(rolesDTO);
     ...
     * 
     * @param rolId Valor del atributo del identificador de la instancia de la entidad  roles a eliminar
    ...
    public String eliminar(@QueryParam("rolId") BigDecimal rolId) {
        ...
        return negocioRoles.eliminar(rolId);
        // protected region Use esta region para su implementacion end
    }
    ...
    public String contar(@QueryParam("filterBy") String filterBy,
        ...
        return negocioRoles.contar(filterBy, from, to);
        // protected region Use esta region para su implementacion end
    }    
     ...
     * parámetro debe ir separado por coma : ','.
     * Ej. Una secuencia de parámetros de ordenamiento puede ser: rolesId$ASC, rolesName$DESC
     * @param atributo Nombre del atributo de la entidad Roles del cual se quieren obtener los diferentes valores.
    ...
    public List<String> consultarLista(@QueryParam("filterBy") String filterBy,
        ...
        // protected region Use esta region para su implementacion on begin
        return negocioRoles.consultarLista(filterBy, orderBy, atributo);
        // protected region Use esta region para su implementacion end
    }     
