...
import co.gov.mineducacion.seguridad.modelo.excepciones.ReflectionException;
import static co.gov.mineducacion.seguridad.modelo.utils.UtilConstantes.INT_PRIMITIVE;
import static co.gov.mineducacion.seguridad.modelo.utils.UtilConstantes.LONG_PRIMITIVE;
...
public class UtilReflection {
	...
	private static final org.apache.log4j.Logger logger = org.apache.log4j.Logger
			.getLogger(UtilReflection.class.getName());
	...
	public static Method consultarMetodoGetAtributo(Object objId, String nombreAtributo) {
		...
		try {
			...
			throw new ReflectionException(
					"El metodo get consultado para el atributo " + nombreAtributo + " no existe.");
