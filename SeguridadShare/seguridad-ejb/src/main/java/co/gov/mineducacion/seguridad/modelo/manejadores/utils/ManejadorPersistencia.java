...
import static co.gov.mineducacion.seguridad.modelo.utils.UtilReflection.consultarAtributoId;
import static co.gov.mineducacion.seguridad.modelo.utils.UtilReflection.consultarAtributoPKCompleja;
import static co.gov.mineducacion.seguridad.modelo.utils.UtilReflection.consultarAtributosClase;
import static co.gov.mineducacion.seguridad.modelo.utils.UtilReflection.consultarMetodoGetAtributo;
import static co.gov.mineducacion.seguridad.modelo.utils.UtilReflection.esPkCompleja;
...
public class ManejadorPersistencia<T> implements Serializable {
	 ...
	 * @param idObj
	 *            Puede ser una instancia de una pk compuesto de una entidad o
	 ...
	 * @param id
	 *            Identificar del objeto del cual se quiere obtener la
	 *            referencia
	 ...
	 * 
	 * @param c
	 *            La clase de la entidad sobre la cual se va a realizar la
	 *            consulta
