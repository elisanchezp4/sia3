...
@XmlRootElement(name = "obtenerRolesPermisosRq")
public class ObtenerRolesPermisosRq {
    ...
    protected JAXBElement<InformacionSesion> informacionSesion;
     ...
     *     
     */
    public JAXBElement<InformacionSesion> getInformacionSesion() {
     ...
     *     
     */
    public void setInformacionSesion(JAXBElement<InformacionSesion> value) {
